...
Hi there! We're thrilled that you'd like to contribute to Emissary. Your help is essential for keeping it great.
...
If you have questions, or you'd like to check with us before embarking on a major development effort, please [open an issue](https://github.com/github/emissary/issues/new).
...
* Use [`golint`](https://github.com/golang/lint#scope)

- Write thorough tests. More than that tests should be very thorough and cover as many (edge) cases as possible. Write both unit and integration tests.
